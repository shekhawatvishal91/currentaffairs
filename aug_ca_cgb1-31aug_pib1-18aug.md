...
- MuleHunter.AI (1–11 Aug) + DoT's Financial Fraud Risk Indicator (21–31 Aug) → merged under one cluster.
- GOBARdhan (Cabinet approval, Section 1) is also the subject of a full PIB backgrounder (1–10 Aug) → merged, PIB detail added.
- MPMS (Cabinet approval, Section 1) also has a full PIB backgrounder (1–10 Aug) with the exact approval date and incentive tiers → merged.
- Tribunal Reforms Bill/NTDG (Section 4) has a full PIB backgrounder (11–18 Aug) on NTC composition/tenure → merged.
- PM Jan Dhan Yojana (Section 3, 12-year milestone) overlaps with PIB's Financial Inclusion backgrounder (RBI FI Index, DBT scale) → merged.
...
- Unclaimed-deposit rule: savings/current inoperative **10 years**, or term deposits unclaimed **10 years** from maturity
- Disinvestment + asset-monetisation mop-up: **₹45,306 crore** FY26 (vs RE ₹33,837 cr); FY27 target ₹80,000 cr

🎯 Exam Angle → GNPA ratio 1.93% is a clean standalone stat; 10-year inoperative rule is a recurring definitional MCQ.
...
- CGSMFI = Credit Guarantee Scheme for Microfinance Institutions 2.0, via **NCGTC**
- Max loan sanctionable = 20% of AUM, capped ₹100 cr (small)/₹200 cr (medium)/₹1,000 cr (large)
- MFI size by AUM: Small <₹500 cr | Medium ₹500 cr–₹2,000 cr | Large >₹2,000 cr

🎯 Exam Angle → 🔥 HIGH — Trap: 15% share vs ₹20,000 cr corpus vs ₹100/200/1,000 cr caps by size.
...
- **C) Fake-currency detection**: border-district branches must install note-authentication machines.

🎯 Exam Angle → 🔥 HIGH — 628 circulars → 64 Master Directions, 11 categories.
...
- **C) Recovery-agent norms**: eff. **1 Jan 2027**; contact only 8 AM–7 PM; India's first phone-lock-restriction framework — no restriction before 30 days overdue, full restriction after 60 days; device restored within 1 hr of payment or ₹250/hr penalty.
- **D) CVA derivative-risk framework** (proposed eff. **1 April 2027**): simplified approach for banks with non-centrally-cleared derivatives ≤₹10 trillion.
- **E) Leverage ratio buffer for G-SIB branches** (proposed eff. **1 April 2027**): min leverage 4% (D-SIBs)/3.5% (others). Current D-SIBs: SBI (+0.80% CET1), HDFC Bank (+0.40%), ICICI Bank (+0.20%).

🎯 Exam Angle → 🔥 HIGH — Don't confuse the three 2027 dates: recovery norms (1 Jan 2027) vs CVA & leverage buffer (both 1 April 2027, different rules).
...
- June 2026 norms: assets **>₹1 trillion** → upper layer, must list within **3 years**; Tata Sons' standalone assets **>₹2 trillion**
- NBFC layers: Base (<₹1,000 cr) → Middle (≥₹1,000 cr) → Upper (≥₹1 lakh cr) → Top

🎯 Exam Angle → 🔥 HIGH — Tata Sons + 3-year listing mandate is a near-certain mains question.
...
- **B) Financial Fraud Risk Indicator (FRI)** — Dept. of Telecommunications tool assessing fraud risk of mobile numbers; 3 risk categories: Medium, High, Very High
- Cybercrime reporting: **1930 Helpline** + National Cyber Crime Reporting Portal

🎯 Exam Angle → MuleHunter.AI (RBI) vs FRI (DoT) — don't confuse the two agencies behind each tool.
...
- **RBI IT Governance Master Directions (2023)**; 2025 Authentication Directions mandate **2FA with ≥1 dynamic factor**
- **SEBI CSCRF, 2024** — 22 regulated-entity types, 5-tier model

🎯 Exam Angle → 🔥 HIGH — Don't confuse ₹250 cr (DPDPA security failure) vs ₹200 cr (breach notification failure).
...
- Rough diamond tax break: new Entry 13F — **15-year exemption** for foreign cos trading rough diamonds via SNZs, 1 Oct 2026–31 Mar 2041
- Capital-goods tax exemption for electronics contract manufacturers extended to 31 Mar 2041
- Appropriation Bill 2026 cleared — ₹54,067 crore FY2022-23 expenditure (Article 114)

🎯 Exam Angle → 🔥 HIGH — 15-year SNZ diamond tax break via Entry 13F.
...
- India's GI ecosystem: **>800** registered GI products; Darjeeling Tea = India's first GI product; target **10,000 GI registrations by 2030**
- EPF inoperative rules: ~3 yrs post-retirement/migration/death; EPF no. = 22-digit; UAN = permanent 12-digit
- SEZ exports up **11.8%** to ₹16,36,192 crore
- PPF: only residents can open fresh accounts

🎯 Exam Angle → 🔥 HIGH — Darjeeling Tea as first GI product + 10,000-by-2030 target.
...
- **Six Growth Engines:** (1) Assured CBG Offtake — CGD entities procure under a notified CBG Obligation trajectory: **3% FY 2026-27 → 4% FY 2027-28 → 5% from FY 2028-29** onwards in CNG (Transport)/PNG (Domestic) segments; (2) Stable Pricing — administered price ₹2,110/MMBTU (~₹105/kg); (3) Capital Assistance — up to ₹2 crore/TPD of installed CBG capacity for greenfield projects; (4) Pipeline Infrastructure — connects CBG plants to trunk pipelines & CGD networks; (5) Credit Guarantee — up to **85%** coverage for eligible MSME-based CBG projects; (6) CBG Ecosystem Challenge Fund — feedstock mapping, aggregation, tech, district planning, manure value addition
- Supporting initiatives: **SATAT** (Sustainable Alternative Towards Affordable Transportation — promotes CBG production/supply to OMCs); **Biomass Aggregation Machinery (BAM) Scheme** — outlay ₹564.75 crore; **Development of Pipeline Infrastructure (DPI) Scheme** — outlay ₹994.5 crore, FY24-25 to FY28-29; **MDA Scheme** — Market Development Assistance for organic manure, ₹1,500/MT; **CFA** — Central Financial Assistance for CBG plants under National Bioenergy Programme
- GOBARdhan Unified Registration Portal — registration required to avail MoPNG benefits/support
- Top-performing states: 1. Uttar Pradesh → 2. Madhya Pradesh → 3. Maharashtra → 4. Gujarat → 5. Telangana; Top banks: 1. SBI → 2. BoB → 3. Union Bank of India → 4. PNB → 5. Indian Bank; Top ULB: Municipal Corporation of Delhi
- 2026-36 expected outcomes: CBG **10×**, fossil-fuel displacement **10 MMT**, forex savings **>₹40,000 cr**, GDP addition **>₹75,000 cr**, **>1.5 lakh jobs**, CO₂ reduction **>40 MT**, organic fertilizer **250 MMT**

🎯 Exam Angle → 🔥 HIGH — Six Growth Engines' CBG Obligation trajectory (3%→4%→5%) is a strong sequencing trap alongside the already-known ₹23,731 cr outlay; don't confuse GOBARdhan's original 2018 launch (under Swachh Bharat) with its 6 Aug 2026 Cabinet-approved revamp.
...
- EV proposal: 4-wheelers (personal) ₹20 lakh; battery-swap/charging ₹25 lakh; commercial fleets ₹50 crore

🎯 Exam Angle → Don't confuse ₹35 cr (current, solar) vs ₹75 cr (proposed, wind/hydro) vs ₹100 cr (overall).
...
🎯 Exam Angle → 60-day timeline for land-bordering-country FDI proposals on specified goods is a clean process fact.
...
- **C) FTP amended for rupee invoicing**: exports outside ACU can now be invoiced in ₹ or any foreign currency (earlier: freely-convertible foreign currency only); ACU (est. 1974, 9 members incl. India, Pakistan, Iran, Bangladesh, Bhutan, Maldives, Myanmar, Nepal, Sri Lanka) exports still ACU-currency-denominated.
- **D) Dak Sewa + Dak MITRA apps revamped** — Jyotiraditya Scindia; 23 Indian languages; built by CEPT under Advanced Postal Tech (APT) platform.

🎯 Exam Angle → One Star Export House's "any 2 of 3 years" relaxation is a clean rule-change MCQ.
...
- Launched **25 August 2016** by NPCI, under RBI oversight
- Transactions: **1.78 crore (2016-17) → 24,162+ crore (2025-26)**; banks live: 44 → 703
- Global share: **~49%** of global real-time payment transaction volume (2025, per IMF); daily transactions >66 crore
- Operational in **11 countries**: UAE, France, Bhutan, Sri Lanka, Nepal, Singapore, Mauritius, Qatar, Cambodia, Greece, Maldives

🎯 Exam Angle → 🔥 HIGH — UPI's 10-year milestone (25 Aug 2016) + ~49% global real-time-payment share (IMF) is a near-certain mains question.
...
- Social Security snapshot: **PMJJBY** 27.78 cr enrolments (₹2 lakh cover, ₹436/yr premium, 18-50 yrs); **PMSBY** 58.66 cr enrolments (₹2 lakh/₹1 lakh cover, ₹20/yr premium, 18-70 yrs); **APY** 9.29 cr subscribers (₹1,000-5,000/month after 60); **PM MUDRA** 57.79 cr loans (collateral-free up to ₹20 lakh); **Jan Samarth** — 54.10 lakh applications, 16 registered credit schemes, 8 loan categories, 300+ lenders
- **UPI** (as of July 2026): transaction volume **2,365 crore**, **741 banks** live

🎯 Exam Angle → 🔥 HIGH — FI Index's 43.4→70.0 rise (2017→2026) is a strong trend MCQ that cross-references PMJDY's 12-year milestone above; don't confuse the FI Index (0-100 composite) with Global Findex's 89% account-ownership figure.
...
- Defence procurement (Dept. of Military Affairs) crossed **₹1.35 lakh crore** cumulative GMV (6 Aug 2026) = **14.93%** of GeM's cumulative GMV
- Inclusion initiatives: SWAYATT, Womaniya, SARAS Collection, Startup Runway 2.0; GeM Suvidha Kendras — 50 pilot centres launched June 2026 with CSC-SPV
- 5 priorities for next decade: Last-mile access, AI (price intelligence/marketplace integrity), Integration (States/PSUs/panchayats/cooperatives), Credit & Sustainability (GeM Sahay/TReDS/green procurement), University Outreach

🎯 Exam Angle → 🔥 HIGH — GeM's 10-year, ₹20 lakh crore cumulative-procurement milestone; defence share (14.93% of GMV) is a sharp standalone stat.
...
🎯 Exam Angle → NIPU-2026's 12–16% RoE band vs NIP-2012 predecessor is a clean scheme-comparison MCQ.
...
- Government measures to strengthen KCC: collateral-free KCC loan limit raised **₹1.6 lakh → ₹2 lakh**, effective **1 January 2025**; supporting portals — Kisan Rin Portal, Jan Samarth Portal, e-KCC, KRISHIKA

🎯 Exam Angle → 🔥 HIGH — ₹1 → ₹2.30 value-addition ratio is a distinctive, easily-tested standalone figure.
...
- Approved by Union Cabinet, **July 2026**; Outlay **₹1,27,500 crore**
- **Six Pillars:** (1) Design — chip designs/IPs/systems, 105 startups already developing chips; (2) Machines & Materials — semiconductor machinery, materials, chemicals & gases; (3) Fabs — more silicon, compound-semiconductor, discrete-component & display fabs; (4) ATMP/OSAT — advanced assembly, testing, marking, packaging; (5) R&D — advanced semiconductor nodes & technologies; (6) Talent — chip-design/clean-room/fab-related skill development

🎯 Exam Angle → 🔥 HIGH — Semicon 2.0's ₹1,27,500 cr outlay and Six Pillars is a near-certain scheme-identification MCQ; don't confuse with the original Semicon India (2021) programme.
...
- CMAS announced in Union Budget 2026-27; Proposed outlay **₹10,000 crore over 5 years**; UNCTAD: ~80% of global merchandise trade (by volume) is transported by sea, containerised cargo ~two-thirds of trade value
- Target: up to **7.5 lakh TEUs/year** domestic manufacturing capacity (~10× existing capacity); support — greenfield, brownfield, operational, testing infra, skilling
- Employment/market opportunity: ~3,000 direct + 50,000+ indirect jobs; **₹1.07 lakh crore** project market opportunity
- **Bharat Container Shipping Line (BCSL)** — MoU signed **February 2026** (Shipping Corporation of India, CONCOR, Jawaharlal Nehru Port Authority, V.O. Chidambaranar Port Authority, Sagarmala Finance Corporation Ltd); proposed investment **~₹99,149 crore**, fleet development of **51 container vessels**, incl. domestic container procurement
- Supporting logistics initiatives: PM Gati Shakti, National Logistics Policy, Sagarmala Programme, ₹70,000 crore Shipbuilding Financial Assistance Package
- First India-manufactured EXIM shipping container rolled out **July 2026** for A.P. Moller–Maersk, unveiled at Maersk–CONCOR Inland Container Depot, Dadri, UP

🎯 Exam Angle → 🔥 HIGH — CMAS's 7.5-lakh-TEU/10× target vs BCSL's 51-vessel/₹99,149 cr investment is a strong dual-scheme trap.
...
- **Hong Kong International Convention (HKC)** for Safe & Environmentally Sound Recycling of Ships — in force **26 June 2025**; India aligned domestic framework; ₹53.5 crore financial assistance for yard modernisation
- **EU Green Listing**: Shree Ram Vessel Scrap and Y.S. Investments included in the draft 16th European List of Ship Recycling Facilities
- **Ship-breaking Credit Note Scheme** (under Ship Building Financial Assistance Scheme (SBFA) 2.0): Credit Note = **40%** of recycled ship's scrap value; usable for payment of up to **5%** of the value of a new vessel built at an Indian shipyard

🎯 Exam Angle → 🔥 HIGH — India's 35.4% global ship-recycling share and 5-years-ahead-of-MIV-2030-schedule achievement is a near-certain mains fact.
...
- **LDB 2.0** (launched September 2025 by Piyush Goyal): enabled high-seas tracking of India's export containers + multimodal shipment visibility; contribution recognised by World Bank's Logistics Performance Index (LPI)
- Receives **over 1.5 crore container searches/month** on average; **10 crore containers tracked** cumulatively

🎯 Exam Angle → LDB's 10-crore-container milestone and 100% EXIM coverage since 2024 is a clean standalone fact.
...
- All India WPI inflation, July 2026: **9.78%** YoY (vs 9.87% June 2026); index for All Commodities: 110.0 (vs 110.2 June)
- New indices introduced: Revised WPI, **Output Producer Price Index (OPPI)**, Trial **Input Producer Price Index (IPPI)**; released by Office of Economic Adviser (OEA), DPIIT
- **Why shift from WPI to PPI?** WPI will continue for **5 years** alongside PPI and will be discontinued thereafter — based on global best practices and IMF recommendations
- New WPI series: Base Year **2022–23**; Number of items **957** (up from 697); new energy sources (Solar, Wind, Nuclear Electricity) included; Crude Petroleum & Natural Gas reclassified from Primary Articles to Fuel & Power; weight calculation via **Gross Value of Output (GVO)** replaces Net Traded Value; Missing-price method — Targeted Mean Imputation replaces Carry Forward
- Release schedule: WPI, OPPI and Trial IPPI released on the **14th of the following month**
- WPI weights: Primary Articles 22.75%, Fuel & Power 14.11%, **Manufactured Products 63.12%**; WPI Food Index (24.99%) = Food Articles (Primary) + Manufacture of Food Products (Manufactured)
- OPPI weights: Agriculture/Forestry/Fishing 22.16%, Mining & Quarrying 3.42%, Manufactured Products 69.94%, Electricity 4.49%

🎯 Exam Angle → 🔥 HIGH — WPI→PPI five-year transition + new base year 2022-23 (957 items, up from 697) is a strong methodology MCQ.
...
🎯 Exam Angle → 🔥 HIGH — Tanzania topping export-growth destinations (+131.2%) is a distinctive, easily-tested "top of list" fact.
...
- **Coconut Promotion Scheme** — announced Union Budget 2026-27, part of a broader **₹350 crore** allocation for high-value agriculture (with cashew, cocoa); envisions India as a global leader in coconut/coir exports by **2030**; Cocomitra (6-10 member trained-climber units); Kera Kaushal Kendra (15-member handicraft groups, ₹2.67 lakh assistance from 2026-27)

🎯 Exam Angle → 🔥 HIGH — India's 1st-in-production/3rd-in-area coconut ranking is a recurring trap; MSP hike figures (₹445/₹400) are a clean standalone.
...
- India's first cooperative-led ride-hailing platform; established **6 June 2025**; registered under Multi-State Cooperative Societies Act, 2002; Ministry of Cooperation
- Founded with support of **8 national-level cooperative institutions**: NCDC, IFFCO, NABARD, KRIBHCO, Amul (GCMMF), NAFED, NDDB, NCEL; vision **"Sahkar se Samriddhi"**; nationwide expansion targeted by **2029**
- **Zero-commission, surge-free pricing model** — Sarathis (drivers) retain full fare earnings: 20% of cooperative earnings credited as Sarathis' capital, 80% distributed by kilometres travelled; airport prepaid booths levy a 7% service charge to cover operational expenses
- Ownership: "Saarthi Hi Maalik" — Sarathis become member-owners via cooperative shareholding; share value **₹100/share**; a Sarathi can become a partner by purchasing shares worth **₹500**
- Social security: Personal Accident Insurance **₹5 lakh**, via IFFCO Tokio at nominal rates

🎯 Exam Angle → 🔥 HIGH — Bharat Taxi as India's first cooperative-led ride-hailing platform (8 founding institutions, zero-commission model) is a near-certain mains fact.
...
- Expected to reduce D-PNG connection payback period from **~10 years to ~3 years**

🎯 Exam Angle → 10-year-to-3-year payback compression is a clean standalone stat.

---

🚫 Skipped (low yield, routine product launches): Wizz Voyager multi-currency travel card (Wizzmoni + Oman Air); IDFC FIRST-IIM Calcutta 'IGNITE' ₹2 cr startup incubation; Razorpay multi-currency EEFC facility; VinFast-Federal Bank inventory-financing MoU; Jio Financial's "Personal CFO" AI feature; Bajaj General's 'My Family Complete' pet-inclusive health cover; Karnataka Bank's Capital Gains Account Scheme; DigiLocker–AAERI 'AAERI Verify' partnership (niche foreign-student-credential use case); SAMRIDH programme completion (routine startup-accelerator wrap-up, already concluded 31 Jan 2026).
...
- **Profitability Metrics**: Return on Assets (RoA) stood at **1.3%** and Return on Equity (RoE) reached **13.8%**, driven by resilient net interest margins and lower provisioning.
...
- **C) Unlisted company share sales**: ≤**200 buyers**/year via private deal ≠ public issue.
- **D–F)** DRs for REITs/InvITs, third-party InvIT investment, ISIN limit for private debt (14→17) — all proposed.
- **G)** SLB revamp, Setu portal, corporate bond tokenisation pilot.
- **H)** Risk-based inspections from FY27.
- **I)** ESG anti-"purpose-washing" rules; BRSR mandatory for top 1,000 listed cos; 19 ERPs registered.

🎯 Exam Angle → 🔥 HIGH — CAS timeline (3:15→3:35 PM); 200-buyer threshold; 14→17 ISIN change.
...
- **C)** Vaulting norms widened — Vault Managers Regulations to cover all bullion-backed SEBI products.
- **D)** F&O retail losses: aggregate net loss **₹91,685 crore FY26** (down from FY25's **₹1.12 lakh crore / ₹1,11,788 cr** figure — ~18% YoY decline); unique individual investors fell to 78.60 lakh; new entrants down ~40%. *(Merged — same underlying SEBI study appeared across both fortnights.)*
- **E)** Stress-testing Z-score cut 10→5 for commodity derivatives.
- **F)** Colour-coded "Credit Risk-o-Meter" proposed — 6 levels: Irish Green (lowest) → Chartreuse → Neon Yellow → Caramel → Dark Orange → Red (highest).
- **G)** Accredited Investor framework widened — new asset thresholds (individuals ≥₹5 cr, corporates ≥₹20 cr); validity 3 years.
- **H)** Fully digital KYC proposed for NRIs/OCIs/foreign nationals.
- **I)** Cybersecurity portals launched: **Incident Reporting Portal** (FIRE-format) + **Cyber Suraksha Portal** (centralised cyber-info hub for market participants), at SEBI's Cyber Defence Symposium, Mumbai, 17–21 Aug 2026. 🔄 *(Confirmed operational in 21–31 Aug batch too.)*
- **J)** MF registration simplified — single Form A replacing Form A+C+D.
- **K)** Settlement framework overhaul — fast-track route for cases ≤₹10 lakh.
- **L)** OBPPs allowed to offer GIFT-IFSC-regulated bonds incl. Sec 54EC bonds.

🎯 Exam Angle → 🔥 HIGH — F&O retail-loss reduction (₹1,11,788 cr/₹1.12 lakh cr → ₹91,685 cr) is a strong reform-impact MCQ; Credit Risk-o-Meter's 6 colour levels is a distinctive trap.
...
🎯 Exam Angle → 🔥 HIGH — Polymer note pilot denominations (₹10, ₹20); don't confuse FCNR(B) (8 June start) vs NRE (19 June start) windows — both end 30 Sept 2026.
...
- **C) Fixed Income Channel Partners (FICPs) proposed** — network to deepen retail corporate-bond access in smaller cities; individual eligibility: Indian citizen, 18+, Class 12 pass + NISM fixed-income cert; enlist with exchange; 21-day application timeline; validity 3 years, renewable.
- **D) Stricter ad norms proposed for online bond platforms** — mandatory disclosure of issuer/tenor/rating/YTM/credit-risk-o-meter; restricts "fixed returns"/"predictable returns"/"passive income" claims.
- **E) Fractional shares** — SEBI asked MCA to recognise fractional-share issuance/holding under proposed Companies Amendment Bill (Canada, Japan, USA already allow this).
- **F) IT Resilience Index (ITRI)** proposed for MIIs (exchanges/depositories/clearing corps) — **9 parameters**; Availability & Security weighted highest (20% each); others 10%/5%. First computation covers half-year ended **31 March 2027**; full operationalisation deadline **28 Feb 2027**.
- **G) Merchant-banker exemption mulled** for small-ticket debt (face value ₹10,000) issued via private placement — reduces compliance cost.

🎯 Exam Angle → 🔥 HIGH — ITRI's 9 parameters with 20%/10%/5% weightage split is a strong new-framework MCQ; FICP's "Class 12 pass + NISM cert" eligibility is a clean standalone fact.
...
- **Call Option Regulations**: Minimum maturity is perpetual; call options can only be exercised after a minimum of **5 years** with prior approval of the RBI.
...
- Meeting: **3-5 Aug 2026**; Chair Sanjay Malhotra
...
💼 Interview Q → *Why did RBI flag El Niño despite holding rates?* → Weak monsoon risk threatens food supply and could push inflation up later even though near-term action wasn't warranted.
...
- **Kiwi Postpaid**: first credit-line-on-UPI, with YES Bank

🎯 Exam Angle → 🔥 HIGH — UPI's highest-ever monthly volume (23.66 bn, July 2026) — update each cycle against the new "UPI turns 10" milestone above.
...
- Standard Chartered: first foreign bank in GIFT City (since 2020) to get in-principle IFSCA capital-markets distribution approval
- RBI imposed **₹59.20 lakh penalty** on IndusInd Bank

🎯 Exam Angle → Trap: three AD Category-II approvals — don't mix up "perpetual" vs "expanded" vs "new."
...
- LIC got RBI nod to raise HDFC Bank stake to **9.99%**

🎯 Exam Angle → 🔥 HIGH — REPCO Bank's unusual MHA (not RBI) administrative control is a good trap fact.
...
- Eff. **1 Oct 2026**: ₹15 + GST per cash withdrawal beyond **4 free transactions/month** from Basic Savings Bank Deposit (BSBD) accounts
- 4 free withdrawals include ATM + branch cash + **AePS** withdrawals (AePS newly counted in the 4-txn limit from 1 Oct 2026 — earlier excluded)
- Digital transactions remain free, unlimited

🎯 Exam Angle → 🔥 HIGH — AePS withdrawals newly counted toward the 4-free-transaction BSBD limit from 1 Oct 2026 is a sharp rule-change trap.
...
- **C) Bank of Baroda UPI Global QR Payments** — enables international visitors to pay at BoB's UPI QR merchants in India (cross-border P2M).

🎯 Exam Angle → 🔥 HIGH — PhonePe's feature-phone UPI "first" (200 million+ user base) is a strong standalone fact.
...
- **Ayushman Bharat Digital Mission**: **96.43 crore+** health records/accounts (ABHA)

🎯 Exam Angle → Ayushman Bharat's 45.5-crore-card figure is a routinely-updated headline stat — track each cycle.

---

🚫 Skipped (low yield, routine): Karnataka Bank's Capital Gains Account Scheme; India's BSE house-price-index rating (already covered under Sec 2); MIB publication awards (moved to Section 7).
...
- **Nuclear**: target **100 GW by 2047**; 5 new reactors this decade; SMR target ≥5 by 2033
- **1 crore youth** to get AI-skilling training over the next year
...
- Three-Stage Nuclear Programme: Stage I (PHWRs) → Stage II (Fast Breeder Reactors) → Stage III (thorium, U-233)

🎯 Exam Angle → 🔥 HIGH — 100 GW nuclear-by-2047 + Sapt Dhara's 7 pillars.
...
- Organ donation: India crossed 5 lakh Aadhaar-verified pledges; ranks 3rd globally; TN = 'Best State' (NOTTO Report)

🎯 Exam Angle → 🔥 HIGH — SC judge-strength 33→37 is a high-probability numeric MCQ.
...
- **ASIP Technologies' ₹2,500 crore OSAT facility**, Vizag — South India's first chip plant, under ISM 1.0
- **L&T's Vyoma.AI** — India's largest single-cluster AI infra (Nvidia B300, Chennai)

🎯 Exam Angle → 🔥 HIGH — South India's first OSAT chip plant (Vizag) under ISM 1.0.
...
- New **1601 series** for utility/courier fraud-curbing; DoT caps SIM cards at 9/subscriber
- **'Param Pragya'** AI supercomputing facility, IIT Delhi Sonipat campus

🎯 Exam Angle → 🔥 HIGH — E-visa port count 88 = 37+38+13, a strong composite-number MCQ.
...
- **NTC's 4 major functions**: Selection, Review performance (monitor tribunals + annual reports), Inquiries, Data (→ National Tribunals Data Grid, covering the already-noted 16 tribunals)
- **Tenure**: NTC Chairperson/Members — 5 years/age 70, whichever earlier; Tribunal Members — 5 years/age 67, whichever earlier; reappointment allowed based on previous service & performance
- **Search-cum-Selection Committees**: for Chairperson selection — Committee Chair is the NTC Chairperson, plus 1 Technical Member, a retired HC Chief Justice, a GoI Secretary/State Chief Secretary (for SATs), 2 empanelled experts, and a Member Secretary; for Member selection — Committee Chair is the NTC Judicial Member, with an analogous composition (retired HC Judge instead of retired Chief Justice)
- Key provisions: Committee Chair holds the **casting vote**; Member Secretary + 2 expert members have **no voting rights**; recommendation = 1 suitable candidate/vacancy + 1 for waiting list; **Timeline** — Secretariat must communicate recommendations to Central Govt within **3 days**; Government must process and appoint within **3 months**

🎯 Exam Angle → 🔥 HIGH — NTC's 2 Judicial + 2 Technical Member composition and the 3-day/3-month appointment timeline is a strong new-body MCQ, layering onto the already-logged NTDG (16 tribunals) fact.
...
🎯 Exam Angle → GNANI AI as one of 12 sovereign-LLM entities under IndiaAI Mission is a good crossover fact with earlier LLM-mission notes.
...
- **Project Elephant** — flagship elephant-conservation programme under MoEFCC; **Gajah Suchana Mobile Application** — national genetic database of registered captive elephants
- Management Effectiveness Evaluation (MEE) launched **2023**, tested in Shivalik, Kaziranga-Karbi Anglong, Mayurbhanj, Nilgiri reserves; Captive Elephant (Transfer or Transport) Rules, **2024**
- Compensation for human-wildlife conflict: death/permanent incapacitation ₹10 lakh; grievous injury ₹2 lakh; minor injury treatment up to ₹25,000

🎯 Exam Angle → 🔥 HIGH — SAIEE 2021-25's "first DNA-based synchronised elephant census" tag + 22,446 population figure is a strong standalone.
...
- **Largest Dhimsa dance** — Guinness record, 13,000+ women, Bhogapuram, AP; Dhimsa originates in **Koraput, Odisha** (confusion trap: performed in AP)
- **Ladakh's first high-altitude wildlife safari**; **Black-Necked Crane Festival**, Ladakh (first edition) — Changthang Sanctuary is India's only breeding site for the Black-Necked **Crane**
- **Maharashtra** declared snakebite a notifiable disease
- **Cabinet approves High Court Bench in Ladakh** — bench of J&K High Court, to improve access to justice in remote Ladakh; Acting CJ of J&K HC: Justice Sanjeev Kumar
- **Khijadiya Bird Sanctuary (Jamnagar, Gujarat)** emerges as key breeding site for the Black-Necked **Stork** (a DIFFERENT bird from the Ladakh Black-Necked Crane above; don't confuse the two); Ramsar-designated wetland; protected under Wild Life (Protection) Act 1972 Schedule II

🎯 Exam Angle → 🔥 HIGH — Black-Necked **Crane** (Ladakh, Changthang) vs Black-Necked **Stork** (Gujarat, Khijadiya) is a sharp new species-location trap this cycle.

---

### INTERNATIONAL

- **India-US AI soyabean research** (NSF-funded, MeitY partner)
- **Nauru renamed Republic of Naoero** — world's 3rd-smallest country by population
- **CBAM** fully operational from 1 Jan 2026 — 6 sectors, EU's "Fit for 55"
...
🚫 Skipped (low yield): NCW's 'Yashoda AI' programme; govt's cloud/AI skilling initiative (NSDC-AWS); AIIA's 'Garbhini Mitra' course; National Conclave on Tribal Languages; CHEMCONNECT 2026 (org-level, no major policy weight).
...
| MoU Between | Purpose |
|---|---|
| Ministry of Ayush + IndiaAI | AI-driven innovation in Ayush |
| Pawan Hans + Noemi Aerospace (Norway) | Electric seaplane/green aviation tech |
| Lohia Aerospace (LASPL) + Massivit (Israel) | India's first commercial large-format additive-mfg facility, Kanpur |
| MoSPI + IDEAS + ISI Kolkata | GDP Nowcasting tool |
| BSE + MSCI | F&O derivative contracts linked to MSCI indices |
| JSW Neo Energy + Bhutan's DGPC | 920 MW Punatsangchhu-III Hydro Project |

🎯 Exam Angle → 🔥 HIGH — Pawan Hans + Norway's Noemi Aerospace (electric seaplanes) remains the standout "first" theme.
...
| MoU Between | Purpose |
|---|---|
| India + Brazil | Deepen telecom/ICT cooperation |
| MeitY + PhonePe | Strengthen PM GatiShakti Mission — PulsePro data integrated into NMP portal via BISAG-N |
| India + Southern African Customs Union (SACU: Botswana, Eswatini, Lesotho, Namibia, South Africa) | ToR to begin PTA negotiations — **India's first ToR for a trade agreement with the African region** |
| PNB + Indian Army | Specialised credit cards — LUXURA (Officers), Parakram (JCOs/Other Ranks) |
| **Reliance Industries + Rolls-Royce** | Sovereign, indigenous combat engine for India's AMCA programme |
| HP Forest Dept + ISB-BIPP | Unlock ₹22,600 crore forest/pastoral-economy potential (5-yr MoU) |
| UNDP India + HUL | Support 50,000 Safai Mitras across 50 cities by 2028 |
| Citigroup + Axis Bank | Finance NRI FCNR(B) deposits |
| India + Mauritius | 5-yr fuel-supply agreement (IOC–STC); Biofuels Country Landscape Policy framework |
| SEBI + Rashtriya Raksha University + NISM | Cybersecurity/research capacity-building for securities market |
| CBN + PHARMEXCIL | Boost pharma exports, curb diversion |
| HAL + Safran Helicopter Engines (via SAFHAL JV) | New 'Aravalli' turboshaft engine for 13-tonne helicopters |
| NABARD + National Bank for Financing Infra & Development | Joint financing for rural-impact infra |
| **India–US Javelin Deal** | Indian Army to acquire ~**100 FGM-148 Javelin ATGMs** — India's formal entry as a Javelin customer (LOA route) |
| DoT + C-DOT | 5-yr End-to-End Optical Network Test Bed, New Delhi |

🎯 Exam Angle → 🔥 HIGH — India-SACU's first-ever African-region trade-agreement ToR is a strong "first"; RIL-Rolls Royce AMCA engine tie-up + India-US Javelin deal (100 missiles) are high-probability defence-crossover MCQs.
...
- **18th BRICS Summit** — Bharat Mandapam, New Delhi, **12–13 Sept 2026**; theme *"Building for Resilience, Innovation, Cooperation and Sustainability"*; India's **4th BRICS Chairship** (previously 2012, 2016, 2021)
- **26th SCO Summit** — Bishkek, Kyrgyzstan; marks **25 years of SCO** (founded 2001, 10 members; India & Pakistan joined 2017 at Astana; Iran 2023, Belarus 2024)

🎯 Exam Angle → 🔥 HIGH — India's 4th BRICS Chairship (2026) — don't confuse with SCO's 25-year milestone (Bishkek) in the same window.
...
| Person | Position |
|---|---|
| **Varsha Ashok Aglawe** | 54th DG, Geological Survey of India — first woman to head it in 176-yr history |
| **K Rajaraman** | Chairman, IFSCA — extension till 65 |
| **Monisha Chakraborty** | Executive Director, RBI |
| **Bimal N Patel** | Judge, ITLOS |
| **N Chandrasekaran** | To step down as Tata Sons chairman |

🎯 Exam Angle → 🔥 HIGH — Varsha Ashok Aglawe as GSI's first woman DG in 176 years remains the standout "first."
...
| Anand Mahindra + S. Somanath (ex-ISRO Chairman) | Non-official directors, RBI Central Board |
| Annie George Mathew, Syed Akbaruddin, Janmejaya Kumar Sinha | Part-time non-official directors, RBI central board (4 yrs) |
| Rajendra Kumar Saboo | MD & CEO, UCO Bank |
| Sundeep Sikka | Chairman, AMFI (Vishal Kapoor — Vice Chairman) |
| Sandeep Kumar | MD & CEO, LIC Housing Finance |
| Peyman Kargar | CEO, TVS Motor |
| **V. Gopikrishna** | First Indian to head the International Federation of Endodontic Associations (IFEA, 49-country body) |
| **Haakon VIII** | King of Norway (succeeds King Harald V) |
| Yuko Keicho (Japan) | Vice President & Auditor General, World Bank Group |
| Parth Jindal | Chairman, JSW MG Motor India |

🎯 Exam Angle → 🔥 HIGH — V. Gopikrishna as first Indian to head IFEA is a fresh, clean "first" fact.
...
- **C) ICAR registers 16 new indigenous livestock breeds** — total now **262**; ICAR-NBAGR (Karnal) is the nodal institute
- **D) South Bihar University (CUSB) secures its first Indian patent** — plasmonic hollow silver nanoshells for solar-catalysis, DST-funded

🎯 Exam Angle → 🔥 HIGH — India's first indigenous 5 kN RDE (D-Propulse, TRL-5) is a fresh startup-driven "first"; don't confuse with the EVEREST engine (800 kN, different propulsion class/company).
...
- AMRIT Platform acts as the digital backbone of the RuTAGe Smart Village Centre (RSVC) ecosystem — technology discovery & validation, deployment tracking, collaboration, monitoring, knowledge management; connects innovators, startups, tech providers, validators, accelerators, implementation partners, funding agencies, academic institutions and rural communities
- RSVC key areas: agriculture, rural enterprises, renewable energy, education, assistive tech, water & sanitation, citizen services; **8 RSVCs** currently supported by NABARD; built on the earlier tripartite MoU between NABARD, OPSA and NABFOUNDATION; Centre of Excellence on RSVCs established at NABARD HO, Mumbai
- NABARD support per RSVC: duration **3 years**, coverage 10–20 villages, **13 technology tracks**, up to **₹30 lakh** per RSVC, focus on PACS; eligible PIAs — PACS, NGOs/Trusts, FPOs, Section 8 Companies, Startups (DIPP), RIRCs/RETs

🎯 Exam Angle → 🔥 HIGH — India's first RAS-based Rainbow Trout facility (SC-entrepreneur-led, VCF-SC funded) is a fresh, distinctive "first."
...
- Clouded Leopard included under the **Species Recovery Programme** of the Integrated Development of Wildlife Habitats (IDWH) Scheme

🎯 Exam Angle → Clouded Leopard CAP's 14 priority landscapes (Northeast India) is a clean standalone fact.
...
- **Indian Space Policy 2023** expanded private participation, defined roles of **NSIL** (ISRO's commercial arm — launch/satellite/space services, tech transfer) and **IN-SPACe** (single-window mechanism for private space activity)
- FDI in Space Sector (liberalised Feb 2024): 74% automatic (satellite mfg/ops), 49% (launch vehicles/spaceports), 100% (satellite/ground-segment components)
- **Chandrayaan Programme**: Chandrayaan-1 (2008) — India's first Moon mission, detected water molecules/hydroxyl; Chandrayaan-2 (2019) — 100 km altitude, 30 cm-resolution imaging; **Chandrayaan-3 (2023)** — India became the first country to soft-land near the Moon's south pole, 4th nation to soft-land on the Moon
- **AstroSat** — India's first dedicated astronomy mission (X-ray/optical/UV bands simultaneously); **Aditya-L1** — India's first Sun mission, launched 2023, positioned ~1.5 million km at the Sun-Earth L1 point, 27 TB+ solar data released publicly
- **NavIC** — positioning/navigation/timing across India + up to 1,500 km beyond its boundary

🎯 Exam Angle → 🔥 HIGH — DAP 2026's up-to-60% indigenous-content requirement is a strong new-policy MCQ.

---

🚫 Skipped (low yield, foreign, no India angle): China's Chang'e-7 lunar mission; NASA's Nancy Grace Roman Space Telescope; SpaceX's back-to-back Falcon 9 launch record.
...
- President Murmu approved **78 gallantry awards**: Kirti Chakra (9) + Shaurya Chakra (19)

🎯 Exam Angle → 🔥 HIGH — LCH Prachand's 156-helicopter order; Kirti Chakra (9) vs Shaurya Chakra (19) ranking trap.
...
- **C) 5th Coast Guard Global Summit** — India to host in New Delhi, **Feb 2027**.

🎯 Exam Angle → 🔥 HIGH — PRAHAAR as India's first comprehensive counter-terrorism policy (7 pillars) is a near-certain mains question.
...
- **A) India Produces First 100% Indigenous AK-203 'Sher' Rifle** — Indo-Russian Rifles Pvt Ltd (IRRPL, India-Russia JV since 2019), Korwa factory, Amethi; 7.62×39mm gas-operated rifle
- **B) Indian Army raises first Baaz Battalion** of sophisticated drones — Punjab; operationalised by Vajra Corps (11 Corps)
- **C) Indian Navy commissions INS Nipun** (31 Aug 2026) — Nistar-class Diving Support Vessel, 75% indigenous, built by Hindustan Shipyard Ltd
- **D) Indian Navy takes delivery of Samarthak** — **India's first indigenous Multi-Purpose Vessel (MPV)**, built by L&T at Kattupalli, >75% indigenous content
- **E) India's first public-private defence avionics facility** — Samtel HAL Display Systems (SHDS), a HAL-Samtel JV, Gurugram — to indigenously produce multifunction displays (MFDs) for fighter aircraft
- **F) DRDO transfers Submarine Fired Decoy (SFD) 'Mohini' tech to BDL** — protects submarines from acoustic-homing torpedoes; also transferred LM2500 gas-turbine tech to Vertex Engineering
...
🚫 Skipped (low yield, foreign or routine): Eagles of Civilisation 2026 (Egypt-China air drill, no India angle); Sahyog HOP TAC (India-Vietnam Coast Guard exercise, routine).
...
🎯 Exam Angle → 🔥 HIGH — India women's hockey team's 52-year-best World Cup finish is a strong standalone; don't confuse with the men's team's 8th-place finish in the same tournament window. Praggnanandhaa's Grand Chess Tour "first" is equally strong.

🚫 Skipped (low yield): JSW's 'Rukna Nahi Hai' campaign; Lausanne Diamond League (Neeraj Chopra 2nd); U20 World Wrestling (Kajal Dhochak); 2026 Asian Games preview; Kanizsa Open chess; Durand Cup; various squash/tennis titles (Velavan Senthilkumar, Abhay Singh, N Sriram Balaji-Anirud Chandrasekar); World Humanoid Robot Games (foreign robotics record); FIFAe Continental Championship Asia (India's inaugural eFootball win).
...
- **C) Mumbai, Delhi-NCR, Bengaluru** feature in APAC top-10 for logistics rental growth (Knight Frank H1 2026) — Mumbai 4th-highest (5.3%), Delhi-NCR 5th (5.2%), Bengaluru 7th (4.4%).

🎯 Exam Angle → 🔥 HIGH — JNPA's 7-spot rank jump (28th→21st) is a clean ranking-improvement MCQ.
...
- **C) ILO-NCAER policy brief** — women's participation in India's platform economy remains limited; recommends Account Aggregator-based portable financial data.
...
- **C) DMRC becomes first metro organisation in India** to receive ISO 55001:2024 asset-management certification (for its Mumbai Metro Line-3 work).
- **D) 2026 TIME100 AI list** (4th edn) — notable Indian-origin names: Arvind Krishna (IBM), Sanjay Mehrotra (Micron), Ravi Kumar S (Cognizant), among others.

🎯 Exam Angle → 🔥 HIGH — DMRC's ISO 55001 "first metro org in India" is a fresh standalone fact.
...
| Book | Author |
|---|---|
| *Bringing the Cheetah Back to India* | Prashant Agrawal |
| *Triumph of the Indian Republic* | Ram Nath Kovind (autobiography) |
| *Belonging: A Journey of Love* | Sonia Gandhi |
| *Sankalp Se Siddhi Ka Modi Yug* | Ghanshyam Tiwari |
| *Kaho Kalidasa* | Yugul Joshi — biographical novel on Mahakavi Kalidasa, launched by Gajendra Singh Shekhawat |

🎯 Exam Angle → Former-President autobiography/biography pairings recur as book-author MCQ material.

### FESTIVALS

- **Onam** (Kerala) — annual Hindu harvest festival.
...
- Union Ministry of Education's Unified District Information System for Education Plus (UDISE+) 2025-26 report on school education; **14.67 lakh schools**, **24.72 crore enrolments**, **1.03 crore teachers**; average teachers/school 7, average enrolments/school 169
- Teachers % increased 8.3% vs 2022-23; Overall PTR **24:1** (NEP 2020 recommends 30:1) — Foundational 10:1, Preparatory 12:1, Middle 17:1, Secondary 21:1
- Dropout rate declined to: Preparatory **1.8%**, Secondary **7.0%**; Retention Rate: Foundational 98.5%, Preparatory 91.1%, Middle 83.7%, **Secondary only 51.9%**
- Gross Enrollment Rate: Secondary 71.7%, Middle 89.6%; Transition Rate: Foundational→Preparatory 99.2%, Preparatory→Middle 93.8%, Middle→Secondary 88.3%
- Single-teacher schools down 3%, zero-enrolment schools down 29%; Digital infra — computer access 69.9%, internet access 67.4%; Basic infra — electricity 95%, girls' toilets 98.5%, handwashing 96.9%, libraries in 90.5% of schools
- Female representation: women teachers 54.9%, girls' enrolment 48.4%; Social composition — OBC largest share (44.9%), followed by General, SC, ST; CWSN — boys 57.16%, girls 42.84%

🎯 Exam Angle → 🔥 HIGH — Secondary-stage retention collapsing to 51.9% (vs 98.5% at Foundational) is a sharp, testable trend fact.
...
- **Gross Enrolment Ratio (GER)**: GER for 18–23 age cohort climbed to **28.4%** (Female GER at **28.5%** surpassed Male GER at **28.3%** for the 6th consecutive year).
- **Gender Parity Index (GPI)**: Stood at **1.01**, indicating higher participation of females relative to males in higher education.
...
| Day | Date | Note |
|---|---|---|
| National Handloom Day | 7 Aug | Swadeshi Movement link (1905) |
| 80th Independence Day | 15 Aug | — |
| World Senior Citizen's Day | 21 Aug | — |
| International Day of Remembrance/Tribute to Victims of Terrorism | 21 Aug | Theme: Healing Through Memory |
| Partition Horrors Remembrance Day | 14 Aug | — |
| National Space Day | 23 Aug | Theme: Towards Viksit Bharat |
| World Water Week | 23–27 Aug | Theme: Water for People and Progress |
| **National Sports Day** | 29 Aug | Major Dhyan Chand's birth anniversary; Khel Ratna renamed from Rajiv Gandhi Khel Ratna, Aug 2021 |
| World Sanskrit Day | 28 Aug | — |
| International Day Against Nuclear Tests | 29 Aug | — |
| National Small Industry Day | 30 Aug | — |
| **World Elephant Day** | 12 Aug | India home to ~60% of world's wild Asian elephants *(cross-ref Sec 4)* |
| **International Clouded Leopard Day** | 4 Aug | CAP launched, 14 priority landscapes *(cross-ref Sec 6)* |

🎯 Exam Angle → 🔥 HIGH — National Sports Day's Khel Ratna-rename fact (from Rajiv Gandhi Khel Ratna, Aug 2021) pairs well with this cycle's "no Khel Ratna recipient in 2025" fact from Section 7 — don't confuse the two.

**Persons in News**

- **Squadron Leader Bhawana Kanth** — first woman to graduate IAF's "Top Gun" course
- **Lakshmanan Meyyappan** — Indian-origin UAE-based professional recognised by Guinness World Records as **World's Youngest Male Chartered Accountant**, qualifying at 16 years 141 days (June 2021)
- **Kaziah Liz Mejo** — Kerala's 19-year-old, won Miss Universe India 2026
- **Aditya Rithvik Narra** *(PIB)* — Scheduled Caste entrepreneur behind India's first RAS-based Rainbow Trout facility *(cross-ref Sec 6)*
- **Virender Singh Basoya** *(PIB)* — wanted international drug trafficker extradited to India under Operation GLOBAL-HUNT *(cross-ref Sec 4)*

🎯 Exam Angle → 🔥 HIGH — Lakshmanan Meyyappan's Guinness "youngest male CA" record is a fresh, clean standalone fact.
...
🎯 Exam Angle → 🔥 HIGH — Overall LFPR declining to 54.6% even as Urban Male LFPR and Regular Wage/Salaried shares rose is a nuanced trend MCQ.
...
- Improvement: annual grievances handled up ~9× to ~27 lakh (2024); average disposal time in Central Ministries fell to **15 days** (2025)
- Does **not** entertain: RTI matters, court/sub-judice matters, religious matters, govt-employee service matters (incl. disciplinary proceedings); supports 22 scheduled languages + English via BHASHINI; GRAI benchmarks Ministries/Departments; officer training under the Sevottam framework
- **Samadhan Didi** — AI-enabled CPGRAMS voice chatbot, launched **30 May 2026**; citizens speak their grievance in preferred language (AI + BHASHINI for speech-to-text/translation/transliteration)
- **NextGen CPGRAMS** (upcoming): voice-enabled registration & chatbot, AI-based categorisation/routing, 22-language support, omni-channel registration
- 10-Step Reform Programme introduced **2022** as the major evolutionary turning point

🎯 Exam Angle → 🔥 HIGH — CPGRAMS' 21-day resolution target vs its actual 15-day average disposal (2025) is a clean overshoot fact.
...
- Gross GST collections grew **15.4%** to over ₹2.11 trillion, July 2026
- Asiatic Lion population: 523 (2015) → 891 (2025)
- Fitch Ratings affirmed India's sovereign rating at 'BBB-', stable — **note: S&P separately affirmed 'BBB/A-2'** *(cross-ref Sec 3)* — two different agencies, two different notches, don't confuse
...
- **Wheat flour export ban lifted** — covers maida, semolina, wholewheat atta, resultant atta, with immediate effect
- **India recorded 18,187 mobile threat detections in Q1 2026** — highest among Asia-Pacific markets tracked by Kaspersky (ahead of Indonesia, China)
- **Gujarat launched India's first Sports Genomics Programme** — combines genetics, sports science, physiology, nutrition for athlete identification
- **US GNIS renamed 'Lake Ontario' to 'Lake America'** — foreign administrative-naming fact, noted for GK value
- **Fortune's World's Most Admired Companies 2026**: Apple #1, Microsoft #2
- **National Teachers' Awards 2026** — President Murmu to present on 5 Sept 2026 (Teachers' Day), Vigyan Bhawan, 48 teachers
- **Divyang Men's Cricket Team of India** won a 7-match T20I series 4-3 vs England (Mixed Disability T20I Series 2026)
- **Banas Bio-CNG Model Plant** — Banas Dairy + Suzuki Motor Corp + NDDB joint initiative, Banaskantha, Gujarat

🎯 Exam Angle → 🔥 HIGH — Jal Jeevan Mission's 7-year/15.91-crore-household milestone remains the strongest updateable "latest data" fact; India's #1 Kaspersky mobile-threat-detection ranking is a fresh, distinctive standalone this cycle.
...
- Union Cabinet approved **Samudra Manthan** (India's most ambitious offshore exploration mission); Ministry of Petroleum & Natural Gas; Central Sector Scheme; Outlay **₹84,084 crore**; Implementation up to **FY 2030-31/31 March 2031**; aim — reduce import dependence (India is world's 3rd-largest crude oil consumer), boost domestic O&G production
- Components: Offshore seismic data acquisition & processing ₹28,534 cr; Accelerated deepwater exploration (60 wells) ₹43,200 cr; Common offshore infra hubs ₹10,000 cr; O&G Mfg/Services Zones + monitoring/support ₹2,350 cr (₹2,000 cr + ₹350 cr)
- Govt support for deepwater drilling: up to **50%** of eligible drilling cost or **₹675 crore/well**, whichever is lower; focus basins — Krishna-Godavari, Cauvery, Mahanadi, Andaman; **~99%** of previously restricted "No-Go" areas in India's EEZ opened for exploration
- Key targets: domestic O&G production to **80 MMTOE annually**; hydrocarbon resource base expansion to **2.2 billion TOE**; potential crude-import reduction ~**₹1 lakh crore annually**

🎯 Exam Angle → 🔥 HIGH — Samudra Manthan's ₹84,084 cr outlay + 99% "No-Go" area opening is a near-certain mains question; don't confuse the ₹675 cr/well cap with the ₹84,084 cr total outlay.
...
- **Part B (Employers)**: incentive up to **₹3,000/month** per eligible additional employee, for 2 years (extended to 3rd/4th years for manufacturing sector)
- One-year impact (Aug 2026): **72+ lakh** first-time employees joined the formal workforce; ~30% beneficiaries are women
- Digital governance: EPFO-linked platform, Aadhaar-based authentication, UAN, ECR filings, Face Authentication Technology on UMANG App, DBT to Aadhaar-linked accounts, PM-VBRY Portal; institutional mechanism — cross-functional teams from EPFO, ESIC, CLC (Chief Labour Commissioner)

🎯 Exam Angle → 🔥 HIGH — PM-VBRY's 72-lakh-first-time-employee one-year impact and the ₹15,000-capped one-time incentive are strong, fresh mains facts.
...
- FY2025-26: highest sanction — Maharashtra (9,40,849 houses); highest completion — Chhattisgarh (5,92,508 houses)

🎯 Exam Angle → PMAY-G's 3.91-crore-sanctioned/3.12-crore-completed snapshot (against the 4.18 crore target) is a clean progress-tracking MCQ.
...
- Court proceedings: mandates courts to order payment of **at least 50%** of the awarded amount to micro/small-enterprise suppliers if a set-aside application is pending **6+ months**
- Mediation to complete within **90 days** of first appearance; arbitration reference within **30 days** of mediation termination; arbitral award within **90 days** of completion of pleadings
- Recovery of dues (mediated settlement/arbitral award) recoverable as an "arrear of land revenue" via District Collector/Deputy Commissioner
- **TReDS**: CPSEs mandated to route invoice settlements through it; invoice discounting rose to **₹3.47 lakh crore** (2025-26)
- States can establish multiple Micro and Small Enterprises Facilitation Councils (MSEFCs) and frame their own rules
- Penalties: decriminalisation — conviction-based fines replaced by graded civil penalties

🎯 Exam Angle → 🔥 HIGH — The MSME Bill's "at least 50% of awarded amount" court-payment mandate and the 90-day mediation timeline are strong, fresh mains facts.
...
🚫 Skipped (low yield, PIB 1–18 Aug, Section-10-adjacent): National Gopal Ratna Award 2026 nomination invitation (routine annual-award announcement — categories: Best Dairy Farmer ₹5/3/2 lakh, Best AIT certificate-only, Special Award NER/Himalayan ₹2 lakh; ceremony on National Milk Day, 26 Nov 2026); NABL's Mobile Food Testing Lab accreditation scheme (niche accreditation-mechanics item, under the Integrated Assessment Programme); NMMSS/Swavalambini/NAVYA scheme roundup (Swavalambini — women-entrepreneurship programme across Assam/Meghalaya/Mizoram/UP/Telangana; NAVYA — adolescent-girl vocational training, expanded to 100 aspirational districts from 27 May 2026 — routine "schemes in news" listing, low distinct mains-yield beyond the district-expansion figure); Indian Pharmacopoeia Commission's WHO-SEARN recognition (Regional Centre of Excellence in Pharmacovigilance + Technical Centre in Quality of Medicines, announced at SEARN's 10th Anniversary Meeting, Kathmandu — single-fact recognition, low mains-testability); MSME Sustainable (ZED) Certification scheme mechanics (Bronze/Silver/Gold tiers, 100% subsidy for women-owned MSMEs since 11 Nov 2023 — routine subsidy-tier detail); Manufacturing Momentum backgrounder (16-17% of GDP, 27 million workers, 2nd-largest mobile manufacturer, 2nd-largest textile/apparel employer, world's largest 2W/3W market — largely restates figures already logged elsewhere); India's Defence Strength/Space Sovereignty backgrounder tables (fully absorbed into Section 6 above); Fresh manual-scavenger survey 2024-25 (zero identified — administrative status update, no new numeric hook); India's Agriculture & Allied Sectors backgrounder (GVA ₹52.08 lakh crore 2025-26, PM-Fasal Bima 92.46 crore+ insured applications, KCC 7.28 crore accounts, e-NAM 1,656 mandis — consolidated stat roundup, core figures already logged via KCC-MISS in Section 1).
...
- **Structural Consolidation**: Union Cabinet approved the restructuring and consolidation of all centrally sponsored agricultural schemes under two simplified umbrella frameworks to eliminate overlap and enhance state flexibility:
  ...
  2. **Krishonnati Yojana (KY)**: Focuses on food security, technological self-reliance, horticulture missions, oilseeds/oil palm missions, and agricultural marketing infrastructure.
- **Total Combined Financial Outlay**: **₹1,01,321.61 crore** (Central Share: **₹69,088.98 crore**; State Share: **₹32,232.63 crore**).
...
## ⏰ STATUS CHECK (as of today's date, 5 September 2026)

Items with future effective dates / "proposed"/"draft" status at time of source, flagged for currency:

- **RBI's four 2027-effective draft frameworks** (Interest Rate Directions, recovery-agent/phone-lock norms, CVA framework, leverage-ratio buffer) and **on-tap UCB licensing**: still in draft/consultation stage — no finalisation confirmed as of this consolidation.
- **SEBI's REIT/InvIT DR proposal, ISIN-limit increase, FPI non-agri commodity derivatives, bullion vaulting expansion, Credit Risk-o-Meter, Accredited Investor changes, NRI/OCI digital KYC, settlement-framework overhaul, FICP network, bond-platform ad norms, fractional shares, IT Resilience Index, merchant-banker exemption**: all still proposal/consultation stage.
- **EPF wage-ceiling hike (₹25,000)**: still pending Cabinet approval, anticipated eff. 1 April 2027.
- **MMDR Amendment Bill 2026** and **Taxation and Other Laws (Amendment) Bill 2026**: bill stage, not yet enacted (Tribunal Reforms Bill 2026 and the MSME Development (Amendment) Bill 2026, by contrast, HAVE been passed by Parliament as of this source cycle).
- **V2V communication mandate**, **MoRTH's EV/CNG age-extension proposal**, **FSSAI's HFSS classification**, **PSB's 2% climate-finance PSL sub-target**: all still proposal stage.
- **N Chandrasekaran's Tata Sons chairmanship exit**: still an announced future event, no confirmed date.
- **SBI's BSBD withdrawal-charge change** (eff. 1 Oct 2026), **NPS charges revision** (eff. 1 Oct 2026), **NBFC/UCB PSL Second Amendment windows** (eff. 30 Sept 2026), **Incentive Scheme for Domestic PNG Connections** (eff. 1 Sept 2026): all forward-dated — the PNG scheme's effective date has just passed as of today (5 Sept 2026) and should be treated as newly in effect, not yet independently re-verified; the rest remain upcoming.
- **18th BRICS Summit** (12–13 Sept 2026), **12th BRICS Environment Ministers' Meeting** (18 Aug 2026 — already held, cross-ref Section 5), and **5th SEMICON India 2026** (from 17 Sept 2026): the BRICS Summit and SEMICON India are still upcoming as of 5 Sept 2026.
- **26th SCO Summit (Bishkek)**: date not specified in source; still pending as of this consolidation.
- **Container Manufacturing Assistance Scheme, Bharat Container Shipping Line**: both still at proposal/early-implementation stage — no confirmed operational milestone yet.
- **Semicon 2.0**: Cabinet-approved (July 2026), implementation ongoing — no milestone dates yet due for status-check.

*No material implementation changes were separately verified beyond what's stated above. Given the volume of RBI/SEBI draft frameworks and newly-added scheme launches (Samudra Manthan, CMAS, PM-VBRY) accumulated across all five source windows, recommend a dedicated re-check once the next batch arrives — several carry 1 Oct 2026 or 1 April 2027 effective dates that will need follow-up confirmation. RRBs' FY2025-26 credit figures, WPI/CPI new-series data, and the UDISE+ 2025-26 Report are historical/completed data releases and do not need a status check.*

---

## 📊 COVERAGE UPDATE — 1st–31st August 2026 (Full Month + PIB + Affairs Mind 400 MCQs Master Consolidated)
**Zone: 🔴 Core**
...
2. **Ship Recycling** — India world's #1 (35.4% global share), 5 years ahead of MIV 2030 schedule
3. **Semicon 2.0** — ₹1,27,500 cr, Six Pillars
4. **Bharat Taxi** — India's first cooperative-led ride-hailing platform
5. **Tribunal Reforms Bill/NTC** — full composition + 3-day/3-month appointment timeline (layered onto NTDG's 16-tribunal fact)

**Full-month top revision priority (cross-cycle, all sources):** 62nd MPC (repo @ 5.25%) · Tata Sons NBFC-UL · UPI@10/PMJDY@12/RBI FI Index cluster · PRAHAAR's 7 pillars · AK-203 'Sher' + Samarthak "firsts" · India's 4th BRICS Chairship · Samudra Manthan (₹84,084 cr) · Ship Recycling #1 status · Semicon 2.0 (₹1,27,500 cr) · Bharat Taxi · Tribunal Reforms Bill/NTC · GeM@10 (₹20 lakh cr cumulative) · CMAS/Bharat Container Shipping Line.
