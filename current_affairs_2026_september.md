...
- **Dismantling Domestic SEBI Regime**:
  • From the date of commencement, domestic SEBI regulations—namely the *SEBI (Prohibition of Insider Trading / PIT) Regulations, 2015* and *SEBI (Prohibition of Fraudulent and Unfair Trade Practices / PFUTP) Regulations, 2003*—**will no longer apply within IFSC**.
  • IFSCA assumes exclusive regulatory and enforcement jurisdiction over all securities listed or traded on IFSC exchanges.
- **Mandatory Trade Disclosure Threshold**:
  • Designated persons and insiders must disclose quarterly trades exceeding **\$25,000 within 2 business days** to the compliance officer and the exchange.
...
• Target MCQ Form: "Under the newly notified IFSCA Market Abuse Regulations 2026, what is the trade disclosure threshold for designated persons?" → Trades exceeding \$25,000 within 2 business days.
...
- **The 5 Mandated Equity Categories**:
  • **Category A**: **80%–100% Equity allocation** → *Aggressive Growth / Very High Risk*
  • **Category B**: **60%–80% Equity allocation** → *High Growth / High Risk*
  • **Category C**: **35%–60% Equity allocation** → *Balanced Growth / Medium Risk*
  • **Category D**: **10%–35% Equity allocation** → *Conservative Growth / Low to Medium Risk*
...
• Target MCQ Form: "Under the PFRDA Multiple Scheme Framework revamp, which category corresponds to a 60%–80% equity allocation?" → Category B (High Growth / High Risk).
...
- **Eligibility & Exemption Conditions**:
  • Applies exclusively to **Category-I FPIs** that allocate **100% of their assets under custody (AUC)** into Government Securities (G-Secs), State Development Loans (SDLs), and Treasury Bills (T-Bills).
...
- **Cash Market Net Settlement Proposal**:
  ...
  • Replaces gross scheme-level fund settlement, eliminating redundant liquidity fragmentation and mitigating overnight intraday capital drag for Asset Management Companies (AMCs).
- **Angel Fund Accredited Investor Mandate Extension**:
...
- **Inclusion in Second Schedule**:
  • Coastal LAB becomes **India's first Local Area Bank** to be inscribed in the **Second Schedule of the Reserve Bank of India Act, 1934**.
  • Headquartered at **Vijayawada, Andhra Pradesh**.
- **Prudential Liquidity & Operational Privileges**:
...
• Statutory Inscription: **Second Schedule of the RBI Act, 1934**.
• Target MCQ Form: "Which bank became India's first Local Area Bank (LAB) to be included in the Second Schedule of the RBI Act, 1934 in September 2026?" → Coastal Local Area Bank.
...
- **Direct Capital Infusion to SIDBI**:
  • As an initial tranche, **\$500 million has been directly disbursed to the Small Industries Development Bank of India (SIDBI)**.
- **Targeted Deployment**:
...
- **LIC's Strategic Banking Stake**:
  ...
  • **Validity Window**: LIC is statutorily mandated to complete the equity acquisition within **one year** from the date of RBI clearance.
  • If shareholding falls below 5%, fresh RBI approval will be required to breach the 5% threshold again.
...
- **Bandhan Bank Four-Tier Credit Card Suite**:
  • Private lender Bandhan Bank formally entered the co-branded and standalone credit card market with a 4-tier product architecture (*Elite, Prime, Pro, and Edge*).
- **Indian Bank Expands to Gulf**:
  • Public sector lender Indian Bank received regulatory clearance to set up its **Representative Office in Dubai, UAE**, to cater to non-resident Indian (NRI) remittances and cross-border trade finance.
- **Axis Bank Launches 'ARISE Homecoming'**:
  • Axis Bank unveiled *"ARISE Homecoming"*, a specialized talent and gender-diversity reintegration program to recruit experienced women professionals returning to the workforce after career breaks.
...
- **The 4-Point Strategic Fintech Charter**:
  1. **Fortified Cybersecurity**: Zero-trust architecture across API payment gateways and cloud cores.
  2. **Ethical Data Protection Standards**: Strict compliance with Digital Personal Data Protection (DPDP) Act frameworks and consent management.
  3. **Collaborative Regulator–Industry Innovation Sandbox**: Scaled testing of agentic AI and smart contracts.
  4. **Fintech Consumer Protection Index**: Institutionalization of a national consumer trust and grievance redressal index.
...
- **PhonePe and Visa Triple Solution at GFF 2026**:
  • Unveiled three joint solutions:
    1. *Tap to Pay*: Enables contactless Visa card payments using NFC on Android smartphones.
    2. *Cross Border Scan to Pay*: PhonePe becomes the **first Indian application** allowing users to scan Visa-supported QR codes across **14 international markets**.
    3. *Smart Accept*: Transforms merchant smartphones into standalone soft-POS terminals without requiring dedicated POS hardware.
- **PayGlocal Launches 'Flash'**:
  • Cross-border payment infrastructure provider PayGlocal unveiled *"Flash"*, an automated global checkout engine reducing transaction abandonment for Indian direct-to-consumer (D2C) exporters.
- **RNFI Services Secures RBI PA In-Principle Nod**:
  • Fintech player RNFI Services received RBI in-principle approval to operate as a domestic online Payment Aggregator (PA).
- **India's First Tokenised Bond Issuance**:
  • Successfully executed India's inaugural **tokenised municipal/corporate bond** issuance using distributed ledger technology (DLT), providing instantaneous atomic delivery-versus-payment (DvP) settlement.
...
- **Public Insurance Registry (PIR) Blueprint**:
  ...
  • Designed as a digital public infrastructure (DPI) utility to serve as a single, immutable repository of all active insurance policies, claims histories, and surveyor reports across life, general, and health segments.
- **Enforcement Penalty on ICICI Lombard**:
  • IRDAI imposed a **₹1 crore monetary penalty** on private non-life insurer **ICICI Lombard General Insurance** for regulatory breaches concerning corporate agent commissions and compliance reporting.
...
- **Rationale for Upgrade**:
  • Robust, resilient domestic economic expansion outperforming emerging-market peers (real GDP growth projected ~6.7%–7.0%).
...
• Target MCQ Form: "Which international credit rating agency upgraded India's sovereign issuer rating to 'A-' in September 2026?" → Japan Credit Rating Agency (JCR).
...
- **Current Account Metrics**:
  • Current Account Deficit (**CAD**) stood at **\$4.2 billion**, translating to **0.4% of India's GDP**.
  • Widened moderately from \$1.3 billion (0.1% of GDP) in Q1 FY26, primarily driven by higher merchandise trade deficit (\$65.1 billion vs \$56.7 billion).
- **Capital Account & Reserves Surge**:
  • Net services receipts expanded to **\$39.7 billion**, supported by software exports and business consulting.
  • Foreign Direct Investment (**FDI**) recorded net inflows of **\$6.3 billion**.
...
- **Expanded Tentative Heritage Tally**: India officially inscribed **4 new cultural and natural sites** onto the **UNESCO World Heritage Tentative List**, taking India's cumulative tentative heritage tally to **57 sites**:
  ...
  2. **Colonial Penal Settlement, Andaman Islands**: Cellular Jail and Viper Island historical complexes embodying the saga of India's freedom struggle and colonial carceral architecture.
...
- **Union Minister Launches 'CSS Shield'**:
  • Dr. Jitendra Singh launched *"CSS Shield"*, an automated real-time compliance and cyber-vigilance software architecture to safeguard Central Secretariat Service files and government portals from cyber exfiltration.
- **Punjab Launches 'Pehchaan' Portal**:
  • Punjab Government launched the *"Pehchaan"* digital public portal to photograph, record, and identify unclaimed bodies across state mortuaries through automated biometric and facial recognition matching.
- **National Vulture Reintroduction Record**:
  • **Melghat and Pench Tiger Reserves (Maharashtra)** emerged as India's most successful sites for reintroducing captive-bred vultures into the wild (celebrated on International Vulture Awareness Day, Sept 5).
...
- **Security Mandate & Venues**:
  • Executed across high-security hubs in the National Capital: **Bharat Mandapam, Jawaharlal Nehru Stadium, Rajghat, and Army Polo Ground**.
...
• Previous Indian Summits: 2012 (New Delhi), 2016 (Goa), 2021 (Virtual).
...
- **IAF Dronathon-2026 at Pokhran**:
  ...
  • Dedicated live-fire testing symposium evaluating cutting-edge domestic Unmanned Aerial Systems (UAS), swarm drones, and Counter-Unmanned Aerial Systems (CUAS) in high-temperature desert terrain.
- **Indian Army Inmates AASHVAST Lab**:
  • The Indian Army inaugurated the **AASHVAST** software security lab at the Directorate General of Electronics and Mechanical Engineering (**DG EME**) HQ in New Delhi.
...
- **Mission Specifications & Launch Vehicle**:
  • Lifted off aboard the **Geosynchronous Satellite Launch Vehicle (GSLV)**.
...
• Orbit: **Geosynchronous Orbit** (continuous real-time coverage).
...
- **High-Energy BAM-H24 Propellant Patent**:
  ...
  • Synthesised from an advanced boron-nitrogen-hydrogen cluster, BAM-H24 delivers substantially higher specific impulse and thermal stability compared to conventional hydroxyl-terminated polybutadiene (HTPB) solid propellants, revolutionizing domestic missile solid rocket motors.
- **GalaxEye Wins US Patent for Satellite Imaging**:
  • Space-tech startup **GalaxEye Space** (incubated at IIT Madras) became India's **first space startup to win a United States Patent** for its proprietary synchronized SAR (Synthetic Aperture Radar) and optical Earth observation imaging system.
...
- **Multilateral 6G Coalition**:
  ...
  • Co-hosted by the US Department of Commerce and the White House Office of Science and Technology Policy (OSTP).
- **Meta Unveils 'Muse' AI Agent**:
  • Mark Zuckerberg's Meta unveiled *"Muse"*, a multimodal AI agentic framework designed to collaborate in real-time gaming, creative arts, and software development.
...
- **4th Indo-German Environmental Forum**:
  • Held in **New Delhi**, co-chaired by Environment Minister Bhupender Yadav and German Minister Carsten Schneider under the theme: *"Together For More Resilience"*.
- **UNEP Global Climate Warning & GCRMN Coral Report**:
...
- **Corporate Succession at World's Most Valuable Tech Firm**:
  ...
  • **Tim Cook** stepped down as CEO after a historic 15-year tenure (having taken the helm in August 2011 succeeding Steve Jobs), transitioning into the role of **Executive Chairman of the Board of Apple**.
- **Vinaya Prakash Singh Re-Elected Secretary-General of APPU**:
  • India's **Vinaya Prakash Singh** was re-elected by acclamation as the **Secretary-General of the Asian-Pacific Postal Union (APPU)** for a second consecutive 4-year term (2027–2030).
  • APPU comprises 32 member nations across Asia-Pacific; headquartered in **Bangkok, Thailand**.
- **Domestic & Corporate Key Appointments**:
  • *Dinesh Sharma*: Appointed Lieutenant Governor (LG) of **Andaman and Nicobar Islands**.
  • *Anil Chakravarthy*: Named Chief Executive Officer of **Adobe Inc.**, succeeding long-serving CEO Shantanu Narayen.
  • *Shenu Agarwal* (MD & CEO, Ashok Leyland): Elected President of the **Society of Indian Automobile Manufacturers (SIAM)**.
...
- **Lionel Messi Retires from International Football**:
  ...
  • Accolades: FIFA World Cup Winner (2022) & Runner-up (2014, 2026); Olympic Gold (2008); 8-time Ballon d'Or winner; 2-time World Cup Golden Ball winner (2014, 2022).
- **Smriti Mandhana All-Time Run-Scoring Record**:
  • Indian batting star **Smriti Mandhana** became the **highest run-scorer in women's international cricket across all formats combined**, surpassing previous milestones in ODIs, T20Is, and Tests.
- **Satwiksairaj Rankireddy & Chirag Shetty Win Historic China Masters**:
  • India's premier badminton duo **Satwiksairaj Rankireddy and Chirag Shetty** clinched the Men's Doubles title at the **China Masters 2026 in Shenzhen**, defeating Chinese pair He Ji Ting and Ren Xiang Yu in straight games to secure India's **first-ever China Masters crown**.
- **India's Record Finish at Pickleball World Cup 2026 (Vietnam)**:
  • At the Pickleball World Cup in **Da Nang, Vietnam**, the Indian contingent recorded its best-ever international finish, bagging **4th position globally** with an unprecedented haul of **41 medals (7 Gold, 17 Silver, 17 Bronze)**.
- **World Archery Para Series (Ahmedabad)**:
  • Indian para-archers won **5 medals (2 Gold, 2 Silver, 1 Bronze)**; Men's Compound Team Gold clinched by Toman Kumar and Shyam Sundar Swami.
